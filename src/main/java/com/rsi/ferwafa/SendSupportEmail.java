...
public  boolean sendMailTestVersion(String fname,String lname,String email,String msgContent) {
 ...
 +"<tr>"
 + "      <td class=\"labelbold\">Application URL</td>\n"
 + "      <td> <a href="+LINK+"RSIProject_v1/home.xhtml>click here to acces the service</a>  </td></tr>"
         + "  </tbody>\n"
         + "</table>\n";
		valid=true;
		/*End send content in table sample*/
